  ...
  <div class="page-content row">
	...
	<div class="sbox-title">
		<div class="sbox-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('{class}/update?return='.$return) }}" class="tips"  title="{{ Lang::get('core.btn_create') }}">
			...
			@endif 
			<a href="{{ URL::to( '{class}/search?return='.$return) }}" class="" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>				
			@if($access['is_excel'] ==1)
			<a href="{{ URL::to('{class}/download?return='.$return) }}" class="tips " title="{{ Lang::get('core.btn_download') }}">
	...
	<div class="sbox-content"> 	
	 ...
	 {!! Form::open(array('url'=>'{class}/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
