...
class CapteurController extends Controller {
    ...
    public $module = 'capteur';
    static $per_page	= '10';
    public function __construct()
    {
        
        $this->beforeFilter('csrf', array('on'=>'post'));
        $this->model = new Capteur();
    ...
    public function getIndex( Request $request )
    {
        ...
        $sort = (!is_null($request->input('sort')) ? $request->input('sort') : 'capteur_id');
        ...
        return view('capteur.index',$this->data);
    }
    ...
    function postSave( Request $request)
    {
        ...
        if ($validator->passes()) {
            $data = $this->validatePost('tb_capteur');
            
            $id = $this->model->insertRow($data , $request->input('capteur_id'));
            
            if(!is_null($request->input('apply')))
            {
                $return = 'capteur/update/'.$id.'?return='.self::returnUrl();
            } else {
                $return = 'capteur?return='.self::returnUrl();
            }
            // Insert logs into database
            if($request->input('capteur_id') =='')
            {
    ...
    public static function display( )
    {
        ...
        if($mode == 'view')
        {
            ...
            if($row)
            {
                ...
                $data['id'] = $id;
                return view('capteur.public.view',$data);
            }
        } else {
            ...
            return view('capteur.public.index',$data);
        }
    }
    function postSavepublic( Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules);
        if ($validator->passes()) {
            $data = $this->validatePost('fb_capteurs');
            $this->model->insertRow($data , $request->input('capteur_id'));
