<?php 
define('CNF_APPNAME','MS Football en salle');
define('CNF_APPDESC','Mesure des performances des joueurs');
define('CNF_COMNAME','MS Football');
define('CNF_EMAIL','info@mycompanyname.com');
define('CNF_METAKEY','FOOTBALL MESURES');
define('CNF_METADESC','Mesure des performances des joueurs DE FOOTBALL');
define('CNF_GROUP','3');
