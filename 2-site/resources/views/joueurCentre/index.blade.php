...
<div class="col-md-6">
@if($access['is_add'] ==1)
<a href="{{ URL::to('joueurCentre/update') }}" class="tips btn btn-sm btn-white"  title="{{ Lang::get('core.btn_create') }}">
...
@endif
<a href="{{ URL::to( 'joueurCentre/search') }}" class="btn btn-sm btn-white" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa fa-search"></i> {{ Lang::get('core.btn_search') }} </a>
</div>
<div class="col-md-6 ">
...
{!! Form::open(array('url'=>'joueurCentre/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
...
<a href="{{ URL::to('joueurCentre/show/'.$row->joueur_id.'?return='.$return)}}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
@endif
@if($access['is_edit'] ==1)
<a  href="{{ URL::to('joueurCentre/update/'.$row->joueur_id.'?return='.$return) }}" class="tips btn btn-xs btn-success" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
@endif
</td>
</tr>
@endforeach
...
$(document).ready(function(){
    ...
    $('#SximoTable').attr('action','{{ URL::to("joueurCentre/multisearch")}}');
        $('#SximoTable').submit();
    });
    $('.copy').click(function() {
        ...
        {
        $('#SximoTable').attr('action','{{ url("joueurCentre/copy")}}');
