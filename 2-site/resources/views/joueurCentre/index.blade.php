...
@if($access['is_add'] ==1)
<a href="{{ URL::to('joueurCentre/update?return='.$return) }}"
...
@endif
<a href="{{ URL::to( 'joueurCentre/search?return='.$return) }}"
class="tips"
...
<a href="{{ URL::to('joueurCentre/download?return='.$return) }}" class="tips " title="{{ Lang::get('core.btn_download') }}">
...
{!! Form::open(array('url'=>'joueurCentre/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
