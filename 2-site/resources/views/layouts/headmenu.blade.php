<div class="row  ">
    <nav style="margin-bottom: 0;"
         role="navigation"
         class="navbar navbar-static-top  nav-inside">
        <div class="navbar-header">
            <a href="javascript:void(0)"
               class="navbar-minimalize minimalize-btn ">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            @if(CNF_MULTILANG ==1)
                <li class="dropdown ">
				 ...
				 <i class="fa fa-angle-down"></i>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
                        @foreach(SiteHelpers::langOption() as $lang)
                            <li><a href="{{ URL::to('home/lang/'.$lang['folder'])}}"><img class="flag-lang" src="{{ asset('sximo/images/flags/'. $lang['folder'].'.png')}}" width="16" height="11"
                                                                                          alt="lang"/> {{  $lang['name'] }}</a></li>
                        @endforeach
                    </ul>
            ...
            @if(Auth::user()->group_id == 1)
                <li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)" title="{{ Lang::get('core.m_controlpanel') }}" data-toggle="dropdown"><i class="icon-cog2"></i> <i
                                class="caret"></i></a>
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
