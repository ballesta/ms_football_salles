	...
	<div class="sbox-title"> 
	 ...
	 <h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>
	 	...
	 	<div class="sbox-tools">
	   		<a href="{{ URL::to('complexesportif?return='.$return) }}" class="tips btn btn-xs btn-white pull-right" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
