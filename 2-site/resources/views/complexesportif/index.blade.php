...
@if($access['is_add'] ==1)
<a href="{{ URL::to('complexesportif/update?return='.$return) }}" class="tips"  title="{{ Lang::get('core.btn_create') }}">
...
@endif
<a href="{{ URL::to( 'complexesportif/search?return='.$return) }}" class="" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>
