...
@if($access['is_add'] ==1)
<a href="{{ URL::to('reseauxsalles/update?return='.$return) }}" class="tips"  title="{{ Lang::get('core.btn_create') }}">
...
@endif
<a href="{{ URL::to( 'reseauxsalles/search?return='.$return) }}" class="" onclick="SximoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>
@if($access['is_excel'] ==1)
<a href="{{ URL::to('reseauxsalles/download?return='.$return) }}" class="tips " title="{{ Lang::get('core.btn_download') }}">
...
{!! Form::open(array('url'=>'reseauxsalles/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
