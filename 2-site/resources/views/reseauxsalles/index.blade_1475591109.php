...
<a href="{{ url($pageModule) }}" class="btn btn-xs btn-white tips"
title="{{ Lang::get('core.btn_clearsearch') }}"><i
class="fa fa-trash-o"></i> {{ Lang::get('core.btn_clearsearch') }} </a>
...
@if($access['is_add'] ==1)
<a href="{{ URL::to('reseauxsalles/update') }}" class="tips btn btn-sm btn-white"
...
@endif
<a href="{{ URL::to( 'reseauxsalles/search') }}" class="btn btn-sm btn-white"
onclick="SximoModal(this.href,'Advance Search'); return false;"
title="{{ Lang::get('core.btn_search') }}"><i
class="icon-search3"></i> {{ Lang::get('core.btn_search') }} </a>
@if($access['is_excel'] ==1)
<a href="{{ URL::to('reseauxsalles/download?return='.$return) }}"
...
@endif
@if($access['is_edit'] ==1)
<a href="{{ URL::to('reseauxsalles/update/'.$row->club_id.'?return='.$return) }}"
class="tips btn btn-xs btn-success"
title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
@endif
</td>
</tr>
@endforeach
