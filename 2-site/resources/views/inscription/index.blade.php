  ...
  <div class="page-content row">
	...
	<div class="sbox-title">
		<div class="sbox-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('inscription/update?return='.$return) }}"
			...
			@endif 
			<a href="{{ URL::to( 'inscription/search?return='.$return) }}"
			   class="tips"
			...
			<a href="{{ URL::to('inscription/download?return='.$return) }}" class="tips " title="{{ Lang::get('core.btn_download') }}">
	...
	<div class="sbox-content"> 	
	 ...
	 {!! Form::open(array('url'=>'inscription/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
