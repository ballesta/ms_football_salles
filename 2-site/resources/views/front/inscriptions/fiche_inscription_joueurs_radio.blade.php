                        ...
                        <div class="frm-row">
                            <div class="spacer-b10 colm colm2">
                                <div class="option-group field">
                                    <label class="option">
                                        <input type="radio" name="joueur_equipe[]"  class="smartfm-ctrl" value="A" >
                                    </label>
                                    <label class="option">
                                        <input type="radio" name="joueur_equipe[]"  class="smartfm-ctrl" value="B" >
                                    </label>
                                    <label class="option">
                                        <input type="radio" name="joueur_equipe[]"   class="smartfm-ctrl" value="x" >
                                    </label>
                                </div>
                            </div><!-- end col -->
                        </div><!-- end row -->
