  ...
  <div class="page-content row">
	...
	<div class="sbox-title">
		<div class="sbox-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('testcombo/update?return='.$return) }}"
			...
			@endif 
			<a href="{{ URL::to( 'testcombo/search?return='.$return) }}"
			   class="tips"
			...
			<a href="{{ URL::to('testcombo/download?return='.$return) }}" class="tips " title="{{ Lang::get('core.btn_download') }}">
	...
	<div class="sbox-content"> 	
	 ...
	 {!! Form::open(array('url'=>'testcombo/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 <td>
						...
						<a href="{{ URL::to('testcombo/show/'.$row->id.'?return='.$return)}}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
						@endif
						@if($access['is_edit'] ==1)
						<a  href="{{ URL::to('testcombo/update/'.$row->id.'?return='.$return) }}" class="tips btn btn-xs btn-success" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
						@endif
