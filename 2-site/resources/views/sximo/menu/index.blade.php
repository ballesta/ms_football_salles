...
@section('content')
    <script type="text/javascript"
            src="{{ asset('sximo/js/plugins/jquery.nestable.js') }}">
    </script>
    <div class="page-content row">
        <div class="page-content-wrapper m-t">
            <div class="sbox  ">
                <div class="sbox-title"> Menu List</div>
                <div class="sbox-content">
                    <div class="col-sm-5" style="padding-bottom:50px;">
                        <ul class="nav nav-tabs" style="margin:10px 0;">
                            <li @if($active == 'top')
                                class="active" @endif >
                                <a href="{{ URL::to('sximo/menu?pos=top')}}">
                                    <i class="icon-paragraph-justify2"></i>
                                    {{ Lang::get('core.tab_topmenu') }}
                                </a>
                            </li>
                            <li @if($active == 'sidebar')
                                class="active"
                                    @endif>
                                <a href="{{ URL::to('sximo/menu?pos=sidebar')}}">
                                    <i class="icon-paragraph-justify2"></i>
                                    {{ Lang::get('core.tab_sidemenu') }}
                                </a>
                            </li>
                        </ul>
                        ...
                        <div id="list2" class="dd" style="min-height:350px;">
                            <ol class="dd-list">
                                @foreach ($menus as $menu)
                                    <li data-id="{{$menu['menu_id']}}"
                                        class="dd-item dd3-item">
                                        <div class="dd-handle dd3-handle"></div>
                                        <div class="dd3-content">{{$menu['menu_name']}}
                                            <span class="pull-right">
                                                <a href="{{ URL::to('sximo/menu/index/'.$menu['menu_id'].'?pos='.$active)}}">
                                            ...
                                            <ol class="dd-list" style="">
                                                @foreach ($menu['childs'] as $menu2)
                                                    <li data-id="{{$menu2['menu_id']}}" class="dd-item dd3-item">
                                                        <div class="dd-handle dd3-handle"></div>
                                                        <div class="dd3-content">{{$menu2['menu_name']}}
                                                            <span class="pull-right">
                                                                <a href="{{ URL::to('sximo/menu/index/'
                                                                            .$menu2['menu_id']
                                                                            .'?pos='.$active)}}">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                            ...
                                                            <ol class="dd-list" style="">
                                                                @foreach($menu2['childs'] as $menu3)
                                                                    <li data-id="{{$menu3['menu_id']}}" class="dd-item dd3-item">
                                                                        <div class="dd-handle dd3-handle"></div>
                                                                        <div class="dd3-content">{{ $menu3['menu_name'] }}
                                                                            <span class="pull-right">
												<a href="{{ URL::to('sximo/menu/index/'.$menu3['menu_id'].'?pos='.$active)}}"><i class="fa fa-edit"></i></a>
												</span>
                                                                        </div>
                                                                    </li>
                                                                @endforeach
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-md-8">
                                ...
                                <p> {{ Lang::get('core.fr_musage') }}
                                    <a href="{{ url('core/template?show=icons')}}" target="_blank"> Font Awesome </a> and <a href="{{ url('core/template?show=icon-moon')}}" target="_blank">
                                        Icomoon </a> class name</p>
                            </div>
                        </div>
                        <div class="form-group  ">
